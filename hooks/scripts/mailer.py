...
#
# $HeadURL: http://svn.collab.net/repos/svn/branches/1.5.x/tools/hook-scripts/mailer/mailer.py $
# $LastChangedDate: 2007-09-25 15:15:57 +0000 (Tue, 25 Sep 2007) $
...
class PipeOutput(MailedOutput):
  ...
  def start(self, group, params):
    ...
    cmd = [ '/usr/local/bin/mailsend' ] + [ '-H', '-F', self.from_addr, '-f', self.from_addr ] + self.to_addrs
